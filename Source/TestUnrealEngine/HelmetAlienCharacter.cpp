...
void AHelmetAlienCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis(TEXT("UpDown"), this, &AHelmetAlienCharacter::UpDown);
	PlayerInputComponent->BindAxis(TEXT("LeftRight"), this, &AHelmetAlienCharacter::LeftRight);
	PlayerInputComponent->BindAxis(TEXT("Yaw"), this, &AHelmetAlienCharacter::Yaw);
}
